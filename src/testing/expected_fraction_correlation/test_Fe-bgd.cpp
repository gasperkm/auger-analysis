{
	...
	// p/Fe treatment
	double x1[] = { 1., 0.5, 0.75, 0.25, 0. };
	double x2[] = { 0.65561, 0.32780, 0.49171, 0.16390, 0. };
	double x3[] = { 0.31122, 0.15561, 0.23341, 0.07780, 0. };

	double y1[] = { 1.02785, 0.50140, 0.75360, 0.25431, -0.00639 };
	double y2[] = { 0.91522, 0.45472, 0.67983, 0.23379, -0.00021 };
	double y3[] = { 0.49253, 0.24379, 0.36582, 0.12598, -0.01271 };
	...
	// He/Fe treatment
	double x11[] = { 1., 0.5, 0.75, 0.25, 0. };
	double x12[] = { 0.65561, 0.32780, 0.49171, 0.16390, 0. };
	double x13[] = { 0.31122, 0.15561, 0.23341, 0.07780, 0. };

	double y11[] = { 1.08159, 0.53687, 0.80524, 0.27435, -0.00639 };
	double y12[] = { 1.03207, 0.49362, 0.74677, 0.26004, -0.00021 };
	double y13[] = { 0.58933, 0.29176, 0.45123, 0.15589, -0.01271 };
	...
	// O/Fe treatment
	double x21[] = { 1., 0.5, 0.75, 0.25, 0. };
	double x22[] = { 0.65561, 0.32780, 0.49171, 0.16390, 0. };
	double x23[] = { 0.31122, 0.15561, 0.23341, 0.07780, 0. };

	double y21[] = { 1.46308, 0.71115, 1.07554, 0.37499, -0.00639 };
	double y22[] = { 1.39969, 0.67875, 1.02974, 0.36019, -0.00021 };
	double y23[] = { 1.06299, 0.50417, 0.74695, 0.26296, -0.01271 };
