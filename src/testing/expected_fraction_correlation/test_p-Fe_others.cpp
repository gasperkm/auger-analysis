{
	...
	double y1[] = { 0.74186, 0.69518, 0.95279 };
        double y2[] = { 0.87109, 0.79732, 0.98224 };
	double y3[] = { 0.61165, 0.59112, 0.92899 };
	...
	double y11[] = { 1.02785, 0.74186, 0.87109, 0.61165, 0.49253 };
	double y12[] = { 0.91522, 0.69518, 0.79732, 0.59112, 0.49253 };
	double y13[] = { 1.02785, 0.95279, 0.98224, 0.92899, 0.91522 };
	...
	cout << endl << "Fitting test_p-Fe_others.cpp ----------------------------------------" << endl;
	gr11->Fit("pol1");
...
/*	TCanvas *c3 = new TCanvas("c3", "", 1200, 800);
	...
	cout << endl << "Fitting test_p-Fe_others.cpp (shifted) ------------------------------" << endl;
	gr21->Fit("pol1");
	...
	c3->SaveAs("fit_p-Fe_others-shift.pdf");*/
}
